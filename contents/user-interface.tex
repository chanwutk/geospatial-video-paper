...
As the output of a query in this language would be a series of clips or videos taken from the overall collection of videos, we envision the interface as having some region in which the output of the queries are displayed. However, this creates some issues, as video data is large. To amend this, we would \shadaj{how will we display videos?}
